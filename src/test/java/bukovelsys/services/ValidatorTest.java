...
public class ValidatorTest {
    ...
    public void validateSeason() {
        ...
        SkiPass seasonSkiPass1 = accountSystem.createSeasonSkiPass(LocalDateTime.of(2019,8));
        SkiPass seasonSkiPass2 = accountSystem.createSeasonSkiPass(LocalDateTime.of(2018,));

        Assert.assertTrue(validator.validateSeason(seasonSkiPass1));
        Assert.assertTrue(validator.validateSeason(seasonSkiPass2));
    }
}